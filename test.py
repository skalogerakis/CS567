...
# TODO Does this covers us??? Satellite is equivalent to Artificial or Natural Satellite
class Satellite(Thing):
    namespace = onto
    # equivalent_to = [Or([NaturalSatellite, ArtificialSatellite])]
...
if __name__ == '__main__':
    ...
    print([x for x in Satellite.ancestors()])
    # print(Galaxy.iri)
